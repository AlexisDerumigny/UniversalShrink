...
#' 
#' LossFrobenius2(precision_OptimalRidge, Sigma = Sigma)
#' LossFrobenius2(precision_NLshrink, Sigma = Sigma, type = "precision matrix")
#' LossFrobenius2(precision_QISshrink, Sigma = Sigma, type = "precision matrix")
#' 
#' 
#' @export
