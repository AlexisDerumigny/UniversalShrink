...
list_GMV = list(
  ...
  GMV_plugin_higher_order_shrinkage_2 = GMV_PlugIn(
    higher_order_shrinkage(Y = t(X), m = 2, centeredCov = TRUE)),
  
  GMV_plugin_higher_order_shrinkage_3 = GMV_PlugIn(
    higher_order_shrinkage(Y = t(X), m = 3, centeredCov = TRUE)),
  
  GMV_plugin_higher_order_shrinkage_4 = GMV_PlugIn(
    higher_order_shrinkage(Y = t(X), m = 4, centeredCov = TRUE)),
  ...
  GMV_plugin_higher_order_shrinkage_6 = GMV_PlugIn(
    higher_order_shrinkage(Y = t(X), m = 6, centeredCov = TRUE))
)
```
